# -*- coding: utf-8 -*-
"""Reproduce TC-HI + Random Forest + hierarchical CAP-MIL v13.6.

This entry point uses the archived I-ModernTCN forecasts that produced the
previous high-performing TC-HI experiment.  Pooling hyperparameters and all
decision thresholds are selected from validation specimens only; the locked
test specimens are evaluated afterwards.
"""
...
DEFAULT_OUTPUT = SCRIPT_DIR / "outputs_tc_hi_cap_mil_v13_6"


def main() -> int:
    parser = argparse.ArgumentParser(
        description="Reproduce TC-HI + Random Forest + CAP-MIL hierarchical warning v13.6"
    )
