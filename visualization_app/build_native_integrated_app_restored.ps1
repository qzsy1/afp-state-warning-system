...
$PyInstallerArgs = @(
    ...
    "--hidden-import", "app", "--hidden-import", "acquisition", "--hidden-import", "interface_agent", "--hidden-import", "smrf_hid",
...
$SourceFiles = @(
    ...
    "acquisition.py", "interface_agent.py", "smrf_hid.py", "mysql_storage.py", "online_inference.py", "atavn.py",
